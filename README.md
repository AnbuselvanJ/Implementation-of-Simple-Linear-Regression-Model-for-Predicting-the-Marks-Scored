...
## Algorithm
1. Start
2. Important required libraries (pandas,matplotlib,LinearRegression)
3. Create dataset containing Hours studied and Marks scored
4. Create Linear Regression model
5. Plot scatter graph and regression line
6. Stop
